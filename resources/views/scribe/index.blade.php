    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-product">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-product-search">
                                <a href="#endpoints-POSTapi-product-search">POST api/product/search</a>
                            </li>
...
<div class="bash-example">
    ...
    --data "{
    \"first_name\": \"rxpkhbanbqpanmdfkiiahff\",
    \"last_name\": \"hvadjylb\",
    \"email\": \"murl56@example.com\",
    \"password\": \"vitae\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="rxpkhbanbqpanmdfkiiahff"
               data-component="body">
    <br>
<p>Must be at least 3 characters. Must not be greater than 255 characters. Example: <code>rxpkhbanbqpanmdfkiiahff</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 3 characters. Must not be greater than 255 characters. Example: <code>hvadjylb</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="murl56@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>murl56@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"email\": \"yost.ephraim@example.org\",
    \"password\": \".#^@o5*UX\\/+\'h\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="yost.ephraim@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>yost.ephraim@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>.#^@o5*UX/+'h</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-product">Display a listing of the resource.</h2>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Authorization" class="auth-value"               data-endpoint="GETapi-product"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-product-search">POST api/product/search</h2>
...
<span id="example-requests-POSTapi-product-search">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-product-search">
</span>
<span id="execution-results-POSTapi-product-search" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-product-search"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-product-search"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-product-search" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-product-search">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-product-search" data-method="POST"
      data-path="api/product/search"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-product-search', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-product-search"
                    onclick="tryItOut('POSTapi-product-search');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-product-search"
                    onclick="cancelTryOut('POSTapi-product-search');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-product-search"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Authorization" class="auth-value"               data-endpoint="POSTapi-product-search"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Content-Type"                data-endpoint="POSTapi-product-search"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Accept"                data-endpoint="POSTapi-product-search"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="search"                data-endpoint="POSTapi-product-search"
               value="nngmjxmoajeaxykf"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>nngmjxmoajeaxykf</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"category\": \"rfmqepyiooslkiyttbylqx\",
    \"item\": \"joz\",
    \"price\": \"9299.01\",
    \"description\": \"Qui velit suscipit quia animi dolor vitae.\",
    \"stock\": 19
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="rfmqepyiooslkiyttbylqx"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>rfmqepyiooslkiyttbylqx</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="item"                data-endpoint="POSTapi-products"
               value="joz"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>joz</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^\d+(.\d{1,2})?$/. Example: <code>9299.01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Qui velit suscipit quia animi dolor vitae."
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>Qui velit suscipit quia animi dolor vitae.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 255. Example: <code>19</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/products/rerum" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/products/rerum"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>rerum</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/products/praesentium" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>praesentium</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/products/reprehenderit" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the product. Example: <code>reprehenderit</code></p>
            </div>
                    </form>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="item_id"                data-endpoint="POSTapi-cart-add"
               value="ex"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="osueszytlrkvgbotuh"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>osueszytlrkvgbotuh</code></p>
        </div>
        </form>
